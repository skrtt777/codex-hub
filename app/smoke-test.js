...
async function main() {
  ...
  if (!homeResponse.ok || !homeMarkup.includes('data-shell="claude-code"') || !homeMarkup.includes('/claude-code-shell.css?v=0.20.2') || !homeMarkup.includes('id="mission-deck"') || !homeMarkup.includes('id="theme-preset-grid"') || !homeMarkup.includes('id="open-chat-list"') || !homeMarkup.includes("workspace-board focus-layout") || !homeMarkup.includes("composer-command-center") || !homeMarkup.includes('id="permission-modal"') || !homeMarkup.includes('id="full-access-confirm"') || !homeMarkup.includes('class="message-queue"') || !homeMarkup.includes('class="conversation-layout"') || !homeMarkup.includes('class="session-inspector"') || !homeMarkup.includes('class="conversation-main"') || !homeMarkup.includes('class="ai-companion-dock"') || !homeMarkup.includes('<ai-companion state="idle"') || !homeMarkup.includes('/components/ai-companion-events.js?v=0.20.2') || !homeMarkup.includes('/components/ai-companion.js?v=0.20.2') || !homeMarkup.includes('/nexo.svg') || homeMarkup.includes('class="chat-mascot"') || homeMarkup.includes('class="ai-core-stage"') || homeMarkup.includes('components/hud-controller.js')) {
  ...
  if (!styleResponse.ok || !styleSource.includes("Codex Hub 0.20.2") || !styleSource.includes("AI Companion 0.19") || !styleSource.includes('ai-companion[data-state="coding"]') || !styleSource.includes('ai-companion[data-state="memoryAccess"]') || !styleSource.includes('body[data-texture="scanlines"]') || !styleSource.includes(".conversation-layout") || !styleSource.includes(".ai-companion-dock") || !styleSource.includes(".permission-mode-grid") || !styleSource.includes(".queued-message") || !styleSource.includes("prefers-reduced-motion")) {
  ...
  if (!shellResponse.ok || !shellSource.includes("Codex Hub 0.20.2") || !shellSource.includes("Claude Code's terminal composition") || !shellSource.includes('body[data-shell="claude-code"] .chat-head') || !shellSource.includes('body[data-shell="claude-code"] .timeline-item.user') || !shellSource.includes('body[data-shell="claude-code"] .composer-wrap') || !shellSource.includes('body[data-shell="claude-code"] .ai-companion-dock') || !shellSource.includes("--cc-width: 1680px") || !shellSource.includes("position: fixed") || !shellSource.includes("@media (max-width: 660px)") || !shellSource.includes("@media (max-height: 700px)")) {
